...
public class Main {
    public static void main(String[] args) {
        // KODUS: 3 funktsiooni, milles on kasutatud vähemalt nelja erinevat tüüpi: void, String, int, chat, long,
        // double, float, boolean
        // tagastab int  parameetriks boolean, tagastab void parameetriks boolean või int , tagastab string parameetriks string
